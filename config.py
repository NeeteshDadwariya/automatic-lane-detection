...
config.HOUGH_THRESHOLD = 90
config.HOUGH_MIN_LINE_LENGTH = 150
config.HOUGH_MAX_LINE_GAP = 100
config.MAX_REGION_HEIGHT = .7
config.LINE_MERGE_COUNT = 2
config.CANNY_TH1 = 250
config.CANNY_TH2 = 255
config.CANNY_APERTURE_SIZE = 7
